process GENOPROBS {
  ...
  output:
  tuple val(chr), val(downsample_to_cov), val(shuffle_bin_radius), file("*_crossovers.RData"), file("*36_state_probs.RData"), file("*8_state_probs.RData"), file("*_cross.RData"), emit: geno_probs_out
